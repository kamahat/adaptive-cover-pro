...
Oscillating awnings now compute shading using a vertical-drop model. `arm_length` upper limit raised from 3.0 m to 6.0 m to match real-world hardware. Thanks to [@muhamedfazalps](https://github.com/muhamedfazalps) for the contribution ([#637]).
