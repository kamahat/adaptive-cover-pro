...
class AdaptiveDataUpdateCoordinator(DataUpdateCoordinator[AdaptiveCoverData]):
    ...
    async def async_apply_user_position(
        ...
        *,
        ...
        Single delegation point for any user-facing command.
        Owns the min-mode floor clamp, the pipeline preemption check,
        manual-override engagement, and dispatch to CoverCommandService.
        """
